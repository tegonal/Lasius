...
import { type Route } from './+types/organisation.stats.users'
...
const OrgStatsUsers = ({ loaderData }: Route.ComponentProps) => {
  const { useBarChart, usersAggregatedChart, usersStreamChart } = loaderData
