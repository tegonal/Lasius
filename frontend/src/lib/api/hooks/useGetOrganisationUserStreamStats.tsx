...
/**
 * Custom hook for fetching organisation user statistics with adaptive granularity.
 ...
 */
export const useGetOrganisationUserStreamStats = (orgId: string, from: string, to: string) => {
