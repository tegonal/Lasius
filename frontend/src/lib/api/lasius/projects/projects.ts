...
export const getGetProjectListKey = (orgId: string) => [`/organisations/${orgId}/projects`] as const
...
export const getCreateProjectMutationFetcher = (
  ...
  return (_: Key, { arg }: { arg: ModelsCreateProject }) => {
...
export const getUpdateProjectMutationFetcher = (
  ...
  return (_: Key, { arg }: { arg: ModelsUpdateProject }) => {
...
export const getInviteProjectUserMutationFetcher = (
  ...
  return (_: Key, { arg }: { arg: ModelsUserToProjectAssignment }) => {
 ...
 */
export const getProjectLastActivityDate = (
  orgId: string,
  projectId: string,
  options?: SecondParameter<typeof lasiusAxiosInstance>,
) => {
  return lasiusAxiosInstance<string | void>(
    { url: `/organisations/${orgId}/projects/${projectId}/last-activity`, method: 'GET' },
    options,
  )
}

export const getGetProjectLastActivityDateKey = (orgId: string, projectId: string) =>
  [`/organisations/${orgId}/projects/${projectId}/last-activity`] as const

export type GetProjectLastActivityDateQueryResult = NonNullable<
  Awaited<ReturnType<typeof getProjectLastActivityDate>>
>
export type GetProjectLastActivityDateQueryError = ErrorType<unknown>

export const useGetProjectLastActivityDate = <TError = ErrorType<unknown>>(
  orgId: string,
  projectId: string,
  options?: {
    swr?: SWRConfiguration<Awaited<ReturnType<typeof getProjectLastActivityDate>>, TError> & {
      swrKey?: Key
      enabled?: boolean
    }
    request?: SecondParameter<typeof lasiusAxiosInstance>
  ...
  const swrKey =
    swrOptions?.swrKey ??
    (() => (isEnabled ? getGetProjectLastActivityDateKey(orgId, projectId) : null))
  const swrFn = () => getProjectLastActivityDate(orgId, projectId, requestOptions)
