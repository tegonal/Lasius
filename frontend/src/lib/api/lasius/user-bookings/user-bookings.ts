...
export const getStartUserBookingCurrentMutationFetcher = (
  ...
  return (_: Key, { arg }: { arg: ModelsStartBookingRequest }): Promise<null> => {
...
export const getStopUserBookingCurrentMutationFetcher = (
  ...
  return (_: Key, { arg }: { arg: ModelsStopBookingRequest }): Promise<null> => {
...
export const getUpdateUserBookingCurrentMutationFetcher = (
  ...
  return (_: Key, { arg }: { arg: ModelsBookingChangeStartRequest }): Promise<null> => {
...
export const getUpdateUserBookingMutationFetcher = (
  ...
  return (_: Key, { arg }: { arg: ModelsEditBookingRequest }): Promise<null> => {
...
export const getAddUserBookingByOrganisationMutationFetcher = (
  ...
  return (_: Key, { arg }: { arg: ModelsAddBookingRequest }): Promise<null> => {
