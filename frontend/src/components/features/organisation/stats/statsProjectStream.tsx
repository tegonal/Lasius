...
import { useGetOrganisationProjectStreamStats } from 'lib/api/hooks/useGetOrganisationProjectStreamStats'
...
export const StatsProjectStream: React.FC = () => {
  ...
  const { data, isValidating } = useGetOrganisationProjectStreamStats(
