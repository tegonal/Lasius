...
import { useGetOrganisationUserStreamStats } from 'lib/api/hooks/useGetOrganisationUserStreamStats'
...
export const StatsUserStream: React.FC = () => {
  ...
  const { data, isValidating } = useGetOrganisationUserStreamStats(
