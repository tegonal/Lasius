...
export const ContextButtonDeactivateProject: React.FC<Props> = ({ variant = 'default', item }) => {
  ...
  return (
    <Wrapper>
      <Button
        ...
        aria-label={t('projects.actions.deactivate', { defaultValue: 'Deactivate project' })}
