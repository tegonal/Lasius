                ...
                {({ open }) => (
                  <>
                    ...
                    <ComboboxButton as="div" className="relative">
                      <ComboboxInput
                        className="input input-bordered w-full cursor-pointer pr-8 text-sm"
                    ...
                    {(selected || inputText) && (
                      <div
                        className="hover:text-accent absolute top-1/2 right-8 z-10 -translate-y-1/2 cursor-pointer"
