...
import {
  ...
  initializerType,
} from 'components/ui/forms/input/datePicker/store/datePickerCreateInitialState'
import { InputDatePickerActionType } from 'components/ui/forms/input/datePicker/store/inputDatePickerActionType'
import { inputDatePickerReducer } from 'components/ui/forms/input/datePicker/store/inputDatePickerReducer'
...
export const InputDatepickerStoreProvider: React.FC<StoreProps> = ({
  ...
  return <InputDatepickerContext.Provider value={store}>{children}</InputDatepickerContext.Provider>
}
